...
use MaxLZp\Algo\Sorting\InsertionSort as SortingInsertionSort;
...
final class InsertionSortTest extends TestCase
{
    ...
    {
        $result = SortingInsertionSort::sort($input);
    ...
    {
        $result = SortingInsertionSort::sort($input, SortDirection::DESC);
        $this->assertSame($expected, $result);
    }
